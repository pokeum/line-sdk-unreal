...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(APITestGetBotFriendshipStatusError, "Tests.API.APITestGetBotFriendshipStatusError",
 ...
 */
bool APITestGetBotFriendshipStatusError::RunTest(const FString& Parameters)
{
	// Test result to return
	bool TestResult = true;
	// Test description
	auto What = TEXT("API Test Get Bot Friendship Status Error");
