...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(APITestVerifyAccessTokenError, "Tests.API.APITestVerifyAccessTokenError",
 ...
 */
bool APITestVerifyAccessTokenError::RunTest(const FString& Parameters)
{
	// Test result to return
	bool TestResult = true;
	// Test description
	auto What = TEXT("API Test Verify Access Token Error");
