...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(APITestGetProfileError, "Tests.API.APITestGetProfileError",
 ...
 */
bool APITestGetProfileError::RunTest(const FString& Parameters)
{
	// Test result to return
	bool TestResult = true;
	// Test description
	auto What = TEXT("API Test Get Profile Error");
