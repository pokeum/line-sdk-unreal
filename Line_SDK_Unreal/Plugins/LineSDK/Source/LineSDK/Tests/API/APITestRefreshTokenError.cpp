...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(APITestRefreshTokenError, "Tests.API.APITestRefreshTokenError",
 ...
 */
bool APITestRefreshTokenError::RunTest(const FString& Parameters)
{
	// Test result to return
	bool TestResult = true;
	// Test description
	auto What = TEXT("API Test Refresh Token Error");
